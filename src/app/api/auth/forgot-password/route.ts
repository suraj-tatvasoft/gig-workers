...
export async function POST(req: Request) {
  try {
    ...
    if (!user) {
      return errorResponse('USER_NOT_FOUND', 'User with this email does not exist.', HttpStatusCode.BAD_REQUEST);
    }
    ...
    return successResponse(null, 'Check your inbox! Password reset link has been sent.', HttpStatusCode.OK);
  } catch (err) {
