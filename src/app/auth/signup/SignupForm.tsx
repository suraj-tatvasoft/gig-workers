...
import { PRIVATE_ROUTE, USER_LOGIN_PAGE_PATH } from '@/constants/app-routes';
    ...
    <>
      ...
      <div className="w-full">
        ...
        <div className="flex justify-center mb-4">
          <Image src={Images.googleIcon} alt="Google Icon" width={24} height={24} className="cursor-pointer" onClick={() => signIn('google', { callbackUrl: PRIVATE_ROUTE.DASHBOARD })} />
        </div>
