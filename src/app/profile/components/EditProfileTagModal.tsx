  ...
  return (
    <div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-[#111] text-white px-6 py-4 rounded-xl">
          <DialogHeader>
            <DialogTitle className="text-lg">Edit Profile Tags</DialogTitle>
            <p className="text-sm text-gray-400">Update your skills, interests, and activities</p>
          </DialogHeader>
