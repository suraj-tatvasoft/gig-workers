    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="mb-2 text-lg font-bold text-white sm:text-xl md:text-2xl lg:text-3xl">Subscription Plans</h1>
            <p className="text-xs text-slate-400 sm:text-sm md:text-base lg:text-lg">Manage your subscription plans and pricing</p>
          </div>
        </div>
